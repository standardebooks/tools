...
complete -c se -A -n "__fish_seen_subcommand_from lint" -s m -l multiprocess -d "use multiprocessing to speed up execution when multiple ebooks are specified; ctrl + c doesn’t work nicely"
