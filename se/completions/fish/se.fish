...
complete -c se -A -n "__fish_seen_subcommand_from add-file" -l type -x -a "dedication dramatis-personae endnotes epigraph glossary halftitlepage ignore" -d "the type of file to add"
