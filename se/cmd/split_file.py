...
import se
from se.common import print_error, strip_bom, is_positive_integer
...
def cmd_split_file() -> int:
	...
	parser.add_argument("-s", "--start-at", metavar="INTEGER", type=is_positive_integer, default="1", help="start numbering chapters at this number, instead of at 1")
	...
	if args.template_file:
		try:
			...
			print_error(f"Not a file: {args.template_file}")
			return se.InvalidFileException.code
	else:
