...
def cmd_extract_ebook() -> int:
	...
	for target in args.targets:
		...
		if extracted_path.exists():
			print_error(f"Directory already exists: {extracted_path}")
		...
		if "Mobipocket E-book" in mime_type:
			...
			print_error(f"Couldn’t understand file type: {mime_type}")
