...
def british2american(plain_output: bool) -> int:
	...
	parser = argparse.ArgumentParser(description="Try to convert British quote style to American quote style. Quotes must already be typogrified using the [command]typogrify[/] tool. This script isn’t perfect; proofreading is required, especially near closing quotes near to em-dashes.", formatter_class=SeHelpFormatter)
