...
def build_spine(plain_output: bool) -> int:
	...
	parser = argparse.ArgumentParser(description="Generate the [xhtml]<spine>[/] element for the given Standard Ebooks source directory and write it to the ebook’s metadata file.", formatter_class=SeHelpFormatter)
