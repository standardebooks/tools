...
def split_file(plain_output: bool) -> int:
	...
	parser.add_argument("-f", "--filename-format", metavar="STRING", type=str, default="chapter-%n.xhtml", help="A format string for the output files; [text]%%n[/] is replaced with the current chapter number; defaults to [text]chapter-%%n.xhtml[/].")
