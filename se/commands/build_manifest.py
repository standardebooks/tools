...
def build_manifest(plain_output: bool) -> int:
	...
	parser = argparse.ArgumentParser(description="Generate the <manifest> element for the given tolstoy.life source directory and write it to the ebook’s metadata file.")
