...
INVISIBLE_TIMES = "\u2062"
PSEUDO_CLASSES_TO_SIMPLIFY = [":has", ":first-child", ":only-child", ":last-child", ":nth-child", ":nth-last-child", ":first-of-type", ":only-of-type", ":last-of-type", ":nth-of-type", ":nth-last-of-type", ":empty"]
...
RICH_THEME = Theme({
	...
	"attr": "plum3",
	"class": "plum3",
	"path": "bold steel_blue3",
	"url": "bold steel_blue3",
	"error": "indian_red",
	"warning": "sandy_brown",
	"queued": "gray69",
	"running": "steel_blue3",
