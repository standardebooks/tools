...
def grouper(iterable: Iterable[_T], n: int, incomplete: str = ..., fillvalue: _U = ...) -> Iterator[tuple[_T | _U, ...]]:
    ...
...
def unique(iterable: Iterable[_T], key: Callable[[_T], object] | None = ..., reverse: bool = ...) -> Iterator[_T]:
    ...

@overload
def iter_except(func: Callable[[], _T], exception: type[BaseException] | tuple[type[BaseException], ...], first: None = ...) -> Iterator[_T]:
    ...

@overload
def iter_except(func: Callable[[], _T], exception: type[BaseException] | tuple[type[BaseException], ...], first: Callable[[], _U]) -> Iterator[_T | _U]:
    ...
...
def iter_index(iterable: Iterable[_T], value: Any, start: int | None = ..., stop: int | None = ...) -> Iterator[int]:
    ...
...
@overload
def reshape(matrix: Iterable[Iterable[_T]], shape: int) -> Iterator[tuple[_T, ...]]:
    ...
...
def running_median(iterable: Iterable[_NumberT], *, maxlen: int | None = ...) -> Iterator[_NumberT]:
    ...
